...
import { Download, CheckCircle, Clock, Award, ListTodo, Heart, AlertCircle, Code2 } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-3xl border border-border bg-white/5 space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-display flex items-center gap-2">
              <ListTodo className="text-orange-400" size={22} /> Daily Placement Habits
            </h3>
            ...
            {habits.map(h => (
              ...
              >
                <span className="flex items-center gap-2.5">
                  <CheckCircle size={16} className={h.done ? "text-orange-400" : "text-slate-600"} />
                  {h.label}
                </span>
        ...
        <div className="p-6 rounded-3xl border border-border bg-white/5 space-y-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 bg-black/30 border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-fuchsia-400"
            />
            <button
              onClick={() => handleGithubAnalyze()}
              disabled={analyzingGithub}
              className="px-4 py-2.5 rounded-xl bg-fuchsia-600 hover:bg-fuchsia-500 text-white font-bold text-xs transition-all disabled:opacity-50"
            >
          ...
          <div className="flex justify-between items-center text-xs pt-1">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/15 bg-white/5 hover:bg-white/10 text-white font-bold text-[11px] transition-all"
            >
          ...
          {githubProfile && (
            <div className="p-4 rounded-2xl bg-black/30 border border-white/5 space-y-3">
              <div className="flex items-center gap-3">
                ...
                />
                <div>
                  <h4 className="text-sm font-bold text-white">{githubProfile.name || githubProfile.login}</h4>
                  <a
              ...
              <div className="grid grid-cols-3 gap-2 text-center text-xs py-1.5 border-t border-b border-white/5">
                <div>
                  <div className="font-bold text-white">{githubProfile.public_repos}</div>
                  <div className="text-[10px] text-slate-500">Repositories</div>
                </div>
                <div>
                  <div className="font-bold text-white">{githubProfile.followers}</div>
                  <div className="text-[10px] text-slate-500">Followers</div>
                </div>
                <div>
                  <div className="font-bold text-white">{githubProfile.following}</div>
              ...
              {projectRecommendations.length > 0 && (
                <div className="space-y-2 pt-1">
                  <span className="text-[11px] font-bold text-orange-400 uppercase tracking-wider block">AI Project Recommendations to upgrade your profile:</span>
      ...
      <div className="space-y-6">
        <div className="p-6 rounded-3xl border border-border bg-white/5 space-y-4">
          <h3 className="text-lg font-display flex items-center gap-2">
            <Clock className="text-rose-400" size={22} /> AI Routine & Schedule Generator
          </h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full bg-black/30 border border-white/10 rounded-xl px-3 py-2.5 text-xs text-white focus:outline-none focus:border-rose-400"
              >
          ...
          <button
            ...
            disabled={generating}
            className="w-full py-3 rounded-full bg-gradient-to-r from-rose-500 to-orange-500 hover:from-rose-600 hover:to-orange-600 font-bold text-sm transition-all text-white flex items-center justify-center gap-1.5"
          >
            <Heart size={16} />
