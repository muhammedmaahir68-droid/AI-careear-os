  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-3xl border border-border bg-white/5 space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-display flex items-center gap-2">
              <ListTodo className="text-foreground" size={22} /> Daily Placement Habits
            </h3>
            ...
            {habits.map(h => (
              ...
              >
                <span className="flex items-center gap-2.5">
                  <CheckCircle size={16} className={h.done ? "text-foreground" : "text-slate-600"} />
                  {h.label}
                </span>
            ...
            <div className="p-4 rounded-2xl bg-card border border-border space-y-3">
              ...
              {projectRecommendations.length > 0 && (
                <div className="space-y-2 pt-1">
                  <span className="text-[11px] font-bold text-foreground uppercase tracking-wider block">AI Project Recommendations to upgrade your profile:</span>
      ...
      <div className="space-y-6">
        <div className="p-6 rounded-3xl border border-border bg-white/5 space-y-4">
          <h3 className="text-lg font-display flex items-center gap-2">
            <Clock className="text-foreground" size={22} /> AI Routine & Schedule Generator
          </h3>
        ...
        {generatedPlan && (
          <div className="p-6 rounded-3xl border border-border bg-white/5 space-y-4">
            <div className="flex justify-between items-center">
              <h4 className="text-xs font-bold text-foreground uppercase tracking-wider">Generated Timetable</h4>
              <button
                onClick={downloadPlan}
                className="text-xs px-3 py-1.5 rounded-lg border border-emerald-500/30 hover:bg-emerald-500/10 text-foreground font-bold flex items-center gap-1.5"
              >
